#+TITLE: Emacs 配置文件
#+AUTHOR: Baojie
#+DATE: Time-stamp: <2025-09-05 19:24:06 baojie>
:PROPERTIES:
...
;; 分屏策略：宽屏优先左右分屏，否则上下分屏
(setq split-width-threshold 120)
(setq split-height-threshold nil)

;; buffer 显示 obey display-buffer-alist
...
- State "HOLD"       from "TODO"       [2025-09-01 Mon 11:58] \\
  有可能是加载的延迟造成的问题
- [X] 新 Frame 的 model line 加粗.
...
(setq completion-lazy-hilit t
      ...
      completion-auto-select nil ;; 'second-tab
